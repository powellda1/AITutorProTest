...
export default function Home() {
  ...
  const [topPanelHeight, setTopPanelHeight] = useState(window.innerHeight * 0.6);
  ...
  useEffect(() => {
    const updateHeight = () => {
      ...
      // Maintain proportional top panel height
      setTopPanelHeight(Math.max(200, newHeight * 0.6));
    };
    ...
    <div className="h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="bg-gray-800 border-b border-gray-700 px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <a 
            href="/style-demo" 
            className="px-4 py-2 bg-accent-tertiary hover:bg-accent-primary rounded-lg text-sm font-medium transition-all duration-200 text-white text-shadow-sm hover:scale-105 hover:shadow-lg"
          >
            Style Demo
          </a>
          <a 
